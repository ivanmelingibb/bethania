...
$año_pagado = $_POST['año_pagado'];
$mes_pagado = $_POST['mes_pagado'];
$monto_pagado = $_POST['monto_pagado'];
$fecha_pagado = $_POST['fecha_pagado'];

$sentencia = $pdo->prepare('INSERT INTO pagos
        (estudiante_id, año_pagado, mes_pagado, monto_pagado, fecha_pagado, fyh_creacion, estado)
        VALUES (:estudiante_id, :año_pagado, :mes_pagado, :monto_pagado, :fecha_pagado, :fyh_creacion, :estado)');

$sentencia->bindParam(':estudiante_id',$estudiante_id);
$sentencia->bindParam(':año_pagado',$año_pagado);
